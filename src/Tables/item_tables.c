...
const u16 gItemsByType[ITEMS_COUNT] =
{
    ...
    [ITEM_X_ATTACK] = ITEM_TYPE_HEALTH_RECOVERY,
	[ITEM_X_SPEED] = ITEM_TYPE_HEALTH_RECOVERY,
    [ITEM_X_ACCURACY] = ITEM_TYPE_HEALTH_RECOVERY,
    [ITEM_X_SP_ATK] = ITEM_TYPE_HEALTH_RECOVERY,
    [ITEM_GUARD_SPEC] = ITEM_TYPE_HEALTH_RECOVERY,
    ...
    [ITEM_X_DEFEND] = ITEM_TYPE_STATUS_RECOVERY,
    ...
    [ITEM_DIRE_HIT] = ITEM_TYPE_PP_RECOVERY,
	...
	[ITEM_DREAM_MIST] = ITEM_TYPE_STAT_BOOST_DRINK,
	[ITEM_MAX_POWDER] = ITEM_TYPE_STAT_BOOST_DRINK,
