...
extern const u8 gTrainerBackPic_AranePal[];
#define gTrainerPalette_Arane gTrainerBackPic_AranePal
...
const struct CompressedSpritePalette gTrainerBackPicPaletteTable[] =
{
    ...
    [TRAINER_BACK_PIC_ARANE] =      {gTrainerPalette_Arane,         TRAINER_BACK_PIC_ARANE},
...
#define gTrainerBackAnims_Arane (const union AnimCmd* const*) 0x8239F54
...
const union AnimCmd* const* const gTrainerBackAnimsPtrTable[] =
{
    ...
    [TRAINER_BACK_PIC_ARANE] = gTrainerBackAnims_Arane,
...
const struct MonCoords gTrainerBackPicCoords[] =
{
    ...
    [TRAINER_BACK_PIC_ARANE] = 	    {.coords = 8, .y_offset = 4},
...
extern const u8 gTrainerBackPic_AraneTiles[];

static const struct SpriteFrameImage sTrainerBackPicTable_Arane[] =
{
	{gTrainerBackPic_AraneTiles, 			0x800, 0},
	{gTrainerBackPic_AraneTiles + 0x0800, 0x800, 0},
	{gTrainerBackPic_AraneTiles + 0x1000, 0x800, 0},
	{gTrainerBackPic_AraneTiles + 0x1800, 0x800, 0},
};
...
const struct SpriteTemplate gSpriteTemplateTable_TrainerBackSprites[] =
{
    ...
    [TRAINER_BACK_PIC_ARANE] =
	{
		.tileTag = 0xFFFF,
		.paletteTag = 0,
		.oam = gOamData_TrainerBacksprite,
		.anims = NULL,
		.images = sTrainerBackPicTable_Arane,
		.affineAnims = gAffineAnims_TrainerBacksprite,
		.callback = gSpriteCB_TrainerBacksprite,
	},
